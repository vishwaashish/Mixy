...
<body>
    ...
    <a id="yours" href="edit-user.php" class="btn btn-outline-slide  font-weight-bold text-uppercase list-group-item  bg-slide text-white" data-aos="fade-up" data-aos-delay="100" style="width: 100%;text-align: left;">
        Edit User
    </a>
                ...
                <table class="table table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="viewpost.php?id=<?php echo $row["user_id"]; ?>&&name=<?php echo $row["name"]; ?> " type="button" name="viewpost" id="<?php echo $row["user_id"]; ?>" class="btn btn-primary btn-xs">Post</a></td>
                            <td><a type="button" class="btn btn-info text-white btn-xs edit_data" data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#update_data" data-id="<?= $row['user_id']; ?>" data-name="<?= $row['name']; ?>" data-status="<?= $row['status']; ?>" data-uploaded_on="<?= $row['uploaded_on']; ?>">Edit</a></td>
                            <td><a type="button" name="view" value="Delete" id="<?php echo $row["user_id"]; ?>" class="btn text-white btn-danger btn-xs view_data">Delete</a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name1" name1="name">
                        </div>
                        <div class="form-group">
